...
class RightJoin implements QueryInterface
{
    /**
     * @var $_table
     */
    ...
    public function buildQuery()
    {
        ...
        return "RIGHT " . ($this->_joinOuter ? "OUTER " : null) . "JOIN " . $this->_table . " AS " . $this->_joinAs . " ON (" . $this->_tableColumn . " = " . $this->_joinColumn . ")";
    }
}